...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void DisplayInputResult_OnValidate_mFDFD941E0CD5C904BD7BF16C379DB1D49D4EEE00 (DisplayInputResult_t5410AA3A488ABA56C071CA844BAAE42D73622FF7 * __this, const RuntimeMethod* method)
{
	...
	{
		// switch (inputType)
		int32_t L_0 = __this->get_inputType_5();
		V_0 = L_0;
		int32_t L_1 = V_0;
		switch (L_1)
		{
...
IL_001e:
	{
		...
		int32_t L_3 = L_2;
		RuntimeObject * L_4 = Box(AxisType_t45CEF046648179DA1FDF98C495D40AA34823C164_il2cpp_TypeInfo_var, &L_3);
		int32_t L_5 = __this->get_axisNumber_6();
		int32_t L_6 = L_5;
		RuntimeObject * L_7 = Box(Int32_t585191389E07734F19F3156FF88FB3EF4800D102_il2cpp_TypeInfo_var, &L_6);
		String_t* L_8 = String_Format_m19325298DBC61AAC016C16F7B3CF97A8A3DEA34A(_stringLiteral6FE2EB9A03CDF5C97481593914D7D863F0FE5F6D, L_4, L_7, /*hidden argument*/NULL);
		Object_set_name_m538711B144CDE30F929376BCF72D0DC8F85D0826(__this, L_8, /*hidden argument*/NULL);
		// break;
		return;
	}
...
IL_0045:
	{
		...
		int32_t L_9 = __this->get_inputType_5();
		int32_t L_10 = L_9;
		RuntimeObject * L_11 = Box(AxisType_t45CEF046648179DA1FDF98C495D40AA34823C164_il2cpp_TypeInfo_var, &L_10);
		int32_t L_12 = __this->get_buttonNumber_7();
		int32_t L_13 = L_12;
		RuntimeObject * L_14 = Box(Int32_t585191389E07734F19F3156FF88FB3EF4800D102_il2cpp_TypeInfo_var, &L_13);
		String_t* L_15 = String_Format_m19325298DBC61AAC016C16F7B3CF97A8A3DEA34A(_stringLiteral6FE2EB9A03CDF5C97481593914D7D863F0FE5F6D, L_11, L_14, /*hidden argument*/NULL);
		Object_set_name_m538711B144CDE30F929376BCF72D0DC8F85D0826(__this, L_15, /*hidden argument*/NULL);
		// break;
		return;
	}
...
IL_002d:
	{
		...
		TextMesh_t327D0DAFEF431170D8C2882083D442AF4D4A0E4A * L_4 = __this->get_displayTextMesh_4();
		int32_t L_5 = __this->get_axisNumber_6();
		int32_t L_6 = L_5;
		RuntimeObject * L_7 = Box(Int32_t585191389E07734F19F3156FF88FB3EF4800D102_il2cpp_TypeInfo_var, &L_6);
		...
		String_t* L_11 = String_Format_m0ACDD8B34764E4040AED0B3EEB753567E4576BFA(_stringLiteral6FB374FAAB4FAB74CFBBCC828F8657A89110BAF1, L_10, /*hidden argument*/NULL);
		float L_12 = Input_GetAxis_m6454498C755B9A2C964875927FB557CA9E75D387(L_11, /*hidden argument*/NULL);
		float L_13 = L_12;
		RuntimeObject * L_14 = Box(Single_tDDDA9169C4E4E308AC6D7A824F9B28DC82204AE1_il2cpp_TypeInfo_var, &L_13);
		String_t* L_15 = String_Format_m19325298DBC61AAC016C16F7B3CF97A8A3DEA34A(_stringLiteral33431061FB309988E60F609A990F2B456CA63E30, L_7, L_14, /*hidden argument*/NULL);
		NullCheck(L_4);
		TextMesh_set_text_m64242AB987CF285F432E7AED38F24FF855E9B220(L_4, L_15, /*hidden argument*/NULL);
		// break;
		return;
	}
...
IL_006d:
	{
		...
		int32_t L_16 = __this->get_buttonNumber_7();
		int32_t L_17 = L_16;
		RuntimeObject * L_18 = Box(Int32_t585191389E07734F19F3156FF88FB3EF4800D102_il2cpp_TypeInfo_var, &L_17);
		String_t* L_19 = String_Format_m0ACDD8B34764E4040AED0B3EEB753567E4576BFA(_stringLiteralB4AB17AF25666479BF1B9F04718B963E43946C3D, L_18, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Enum_t2AF27C02B8653AE29442467390005ABC74D8F521_il2cpp_TypeInfo_var);
		bool L_20 = Enum_TryParse_TisKeyCode_tC93EA87C5A6901160B583ADFCD3EF6726570DC3C_m39C4CA535375D57EB557A81EF4B76FEC031A64B0(L_19, (int32_t*)(&V_1), /*hidden argument*/Enum_TryParse_TisKeyCode_tC93EA87C5A6901160B583ADFCD3EF6726570DC3C_m39C4CA535375D57EB557A81EF4B76FEC031A64B0_RuntimeMethod_var);
		if (!L_20)
		{
			goto IL_018c;
		}
	}
	{
		...
		TextMesh_t327D0DAFEF431170D8C2882083D442AF4D4A0E4A * L_21 = __this->get_displayTextMesh_4();
		int32_t L_22 = __this->get_buttonNumber_7();
		int32_t L_23 = L_22;
		RuntimeObject * L_24 = Box(Int32_t585191389E07734F19F3156FF88FB3EF4800D102_il2cpp_TypeInfo_var, &L_23);
		int32_t L_25 = V_1;
		bool L_26 = Input_GetKey_m46AA83E14F9C3A75E06FE0A8C55740D47B2DB784(L_25, /*hidden argument*/NULL);
		bool L_27 = L_26;
		RuntimeObject * L_28 = Box(Boolean_tB53F6830F670160873277339AA58F15CAED4399C_il2cpp_TypeInfo_var, &L_27);
		String_t* L_29 = String_Format_m19325298DBC61AAC016C16F7B3CF97A8A3DEA34A(_stringLiteral50B513476C44C4C0D8F32FE3219FC397F34664A0, L_24, L_28, /*hidden argument*/NULL);
		NullCheck(L_21);
		TextMesh_set_text_m64242AB987CF285F432E7AED38F24FF855E9B220(L_21, L_29, /*hidden argument*/NULL);
		// break;
		return;
	}
...
IL_00ba:
	{
		...
		TextMesh_t327D0DAFEF431170D8C2882083D442AF4D4A0E4A * L_30 = __this->get_displayTextMesh_4();
		NullCheck(L_30);
		TextMesh_set_text_m64242AB987CF285F432E7AED38F24FF855E9B220(L_30, _stringLiteral28FED197ABA6B0075AA7B18880CBE300693BB570, /*hidden argument*/NULL);
...
IL_00ce:
	{
		...
		String_t* L_34 = String_Format_m0ACDD8B34764E4040AED0B3EEB753567E4576BFA(_stringLiteral6FB374FAAB4FAB74CFBBCC828F8657A89110BAF1, L_33, /*hidden argument*/NULL);
		float L_35 = Input_GetAxis_m6454498C755B9A2C964875927FB557CA9E75D387(L_34, /*hidden argument*/NULL);
		V_3 = L_35;
		// if (reading != 0.0)
		float L_36 = V_3;
		if ((((double)(((double)((double)L_36)))) == ((double)(0.0))))
		{
			goto IL_011d;
		}
	}
	{
		...
		TextMesh_t327D0DAFEF431170D8C2882083D442AF4D4A0E4A * L_37 = __this->get_displayTextMesh_4();
		TextMesh_t327D0DAFEF431170D8C2882083D442AF4D4A0E4A * L_38 = L_37;
		NullCheck(L_38);
		String_t* L_39 = TextMesh_get_text_m82229563FBF187061DDBCB5305CB227513B6ED83(L_38, /*hidden argument*/NULL);
		int32_t L_40 = V_2;
		int32_t L_41 = L_40;
		...
		String_t* L_46 = String_Format_m19325298DBC61AAC016C16F7B3CF97A8A3DEA34A(_stringLiteralD95F39C503EAA958DC1BCE86E2C4A4612B82C155, L_42, L_45, /*hidden argument*/NULL);
		String_t* L_47 = String_Concat_mB78D0094592718DA6D5DB6C712A9C225631666BE(L_39, L_46, /*hidden argument*/NULL);
		NullCheck(L_38);
		TextMesh_set_text_m64242AB987CF285F432E7AED38F24FF855E9B220(L_38, L_47, /*hidden argument*/NULL);
	}
...
IL_012b:
	{
		...
		String_t* L_53 = String_Format_m0ACDD8B34764E4040AED0B3EEB753567E4576BFA(_stringLiteralB4AB17AF25666479BF1B9F04718B963E43946C3D, L_52, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Enum_t2AF27C02B8653AE29442467390005ABC74D8F521_il2cpp_TypeInfo_var);
		bool L_54 = Enum_TryParse_TisKeyCode_tC93EA87C5A6901160B583ADFCD3EF6726570DC3C_m39C4CA535375D57EB557A81EF4B76FEC031A64B0(L_53, (int32_t*)(&V_5), /*hidden argument*/Enum_TryParse_TisKeyCode_tC93EA87C5A6901160B583ADFCD3EF6726570DC3C_m39C4CA535375D57EB557A81EF4B76FEC031A64B0_RuntimeMethod_var);
		if (!L_54)
		{
			goto IL_0180;
		}
	...
	}
	{
		...
		TextMesh_t327D0DAFEF431170D8C2882083D442AF4D4A0E4A * L_58 = __this->get_displayTextMesh_4();
		TextMesh_t327D0DAFEF431170D8C2882083D442AF4D4A0E4A * L_59 = L_58;
		NullCheck(L_59);
		String_t* L_60 = TextMesh_get_text_m82229563FBF187061DDBCB5305CB227513B6ED83(L_59, /*hidden argument*/NULL);
		int32_t L_61 = V_4;
		int32_t L_62 = L_61;
		...
		String_t* L_67 = String_Format_m19325298DBC61AAC016C16F7B3CF97A8A3DEA34A(_stringLiteral6F6A465F04662494BCF2CDD14B39035E925D63B3, L_63, L_66, /*hidden argument*/NULL);
		String_t* L_68 = String_Concat_mB78D0094592718DA6D5DB6C712A9C225631666BE(L_60, L_67, /*hidden argument*/NULL);
		NullCheck(L_59);
		TextMesh_set_text_m64242AB987CF285F432E7AED38F24FF855E9B220(L_59, L_68, /*hidden argument*/NULL);
	}
...
IL_0186:
	{
		// for (int i = 0; i < UnityInputButtonCount; i++)
		int32_t L_70 = V_4;
		if ((((int32_t)L_70) < ((int32_t)((int32_t)20))))
		{
			goto IL_012b;
		}
	}
